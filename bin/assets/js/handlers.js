...
(function () {
  ...
  n2a(document.querySelectorAll('[data-onclick="mark_watched"]')).forEach(function (e) {
    e.onsubmit = function () { mark_watched(e); };
  } );
  ...
  function revoke_token(target) {
    ...
    var referer = window.encodeURIComponenent(document.location.href);
    var url = 'token_ajax?action_remove_token=1&redirect=false' +
      '&referer=' + referer +
    ...
    var csrf_token = target.parentNode.querySelectorAll('input[name="csrf_token"]').value;
